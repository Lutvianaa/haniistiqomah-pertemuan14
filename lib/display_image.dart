...
class _DisplayImagePageState extends State<DisplayImagePage> {
  ...
  Future<void> fetchImages() async {
    final response = await http.get(Uri.parse("http://10.10.24.112/image_flutter/fetch_images.php"));
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final imageUrl = "http://10.10.24.112/image_flutter/uploads/${imageInfo['file_name']}";
